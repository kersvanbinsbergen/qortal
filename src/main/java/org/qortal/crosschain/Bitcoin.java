		...
		MAIN {
			...
			public Collection<ElectrumX.Server> getServers() {
				return Arrays.asList(
						...
						new Server("2azzarita.hopto.org", Server.ConnectionType.SSL, 50006),
						new Server("electrum1.baremetalpittsburgh.net", Server.ConnectionType.SSL, 50002),
						new Server("electrum2.baremetalpittsburgh.net", Server.ConnectionType.SSL, 50002),
						new Server("btc.rossbennetts.com", Server.ConnectionType.SSL, 50082),
						new Server("elex-test.1209k.com", Server.ConnectionType.SSL, 50002),
